...
public class TradeController {
    ...
    @PutMapping("/{id}/sell")
    public ResponseEntity<Trade> sellTrade(@PathVariable Long id) {
    ...
    // return tradeService.getAvailableTradesForSale();
    // }
...
// @GetMapping("/status/{statusCode}")
// public List<TradeResponse> getTradesByStatusCode(@PathVariable int
// statusCode) {
// return tradeService.getTradesByStatusCode(statusCode);
// }
// }